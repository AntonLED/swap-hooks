...
values in hundredths of a basis point), and
$\operatorname{clamp}(x)=\min(\max(x,f_{\min}),f_{\max})$ denotes
projection onto that box (per-side bounds where noted). All share the
same harness path;
