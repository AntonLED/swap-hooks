...
Each minute, each direction independently draws one candidate trade of
lognormal size (mean-preserving, $\sigma=1$) around its share of the
minute's demand and executes it all-or-nothing with probability
...
\appendix[Derivation of the Arbitrage Optimum]
\label{app:arb}
